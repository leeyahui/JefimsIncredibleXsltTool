...
namespace XsltTool.Lib
{
    public class ColorTheme
    {
        ...
        {
            Id = "VS Dark",
            AvalonXmlHighlightResourceName = "XsltTool.NetCore.Resources.AvalonXmlDarkTheme.xml",
            IconSymbol = "👻",
        ...
        {
            Id = "VS Light",
            AvalonXmlHighlightResourceName = "XsltTool.NetCore.Resources.AvalonXmlLightTheme.xml",
            IconSymbol = "💡",
